...
class RegisterEventForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['title'].widget.attrs['aria-describedby'] = "addon-wrapping6"

        self.fields['detail'].widget.attrs['placeholder'] = "Add details"
        self.fields['detail'].widget.attrs['row'] = "6"
        self.fields['detail'].widget.attrs['aria-describedby'] = "addon-wrapping7"
...
class AddTaskForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['detail'].widget.attrs['placeholder'] = "Add details"
        self.fields['detail'].widget.attrs['row'] = "6"
        self.fields['detail'].widget.attrs['aria-describedby'] = "addon-wrapping3"
        self.fields['deadline'].widget.attrs['onfocus'] = "this.type='date'"
        self.fields['deadline'].widget.attrs['aria-describedby'] = "addon-wrapping4"